...
| | |
|---|---|
| Tests | 607 — 565 under `make check`, 42 driving a real browser. The line `make check` prints counts skips too, so it can read one or two higher where an optional dependency is missing. |
